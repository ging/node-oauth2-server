...
ImplicitGrantType.prototype.handle = function(request, client, user, scope, nonce) {
  ...
  return Promise.bind(this)
    ...
    .then(function() {
      if (response_types.includes('token')) {
        return this.saveToken(user, client, scope, request, nonce);
      } else {
...
ImplicitGrantType.prototype.saveToken = function(user, client, scope, request, nonce) {
