...
TokenHandler.prototype.getClientCredentials = function(request) {
  ...
  if (request.query.client_id/* && request.body.client_secret*/) {
    return { clientId: request.query.client_id, clientSecret: '%%' /*request.body.client_secret*/ };
  }
