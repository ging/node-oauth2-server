 ...
 *
 */
var implicitHandler = require('../grant-types/implicit-grant-type')
  ...
  return Promise.all(fns).bind(this).spread(function(client, user) {
    ...
    return Promise.bind(this).then(function() {
      ...
      return this.generateAuthorizationCode(client, user, scope);
        ...
        return this.updateResponse(response, redirectUri, state);
        //return code;
    }).catch(function(e) {
...
AuthorizeHandler.prototype.handleTokenResponseType = function(request, response) {
  ...
  return Promise.all(fns).bind(this).spread(function(client, user) {
    ...
    return Promise.bind(this).then(function() {
      ...
      return new implicitHandler(options).handle(request, client, user);
